...
- Sen jälkeen loopissa tapahtuu parillisuuden tarkistus `test $0x1, %al`, jossa parillinen indeksiin lisätään 3 (add $0x3)  ja parittomat indeksit vähentyvät 7:llä (sub $0x7).
