...
- Toinen tarkistusblokki on `0x11c9`, joka on check_pw eli sisältötarkistus. `test eax, eax` tarkistaa funktion paluuarvon, onko 0 tai ei, jos on 0 niin se siirtyy onnistumispolkuun, jos ei se tulostaa fail-polun "No..."

<img width="225" height="197" alt="image" src="https://github.com/user-attachments/assets/65352380-c623-46d1-b6f9-bb793a942a49" />


- Voidaan päätellä, jos pituustarkistus onnistuu se hyppää suoraan onnistumispolkuun, jos taas sisältötarkistus epäonnistuu se hyppää suoraan virhetulostukseen.
