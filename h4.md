...
- Bash-kielessä `!` tarkoittaa history-expansionia, tässä tilanteessa, kun huutomerkin muuttaa `´\`-merkiksi kertoo se ohjelmalle, että tämä ottaa seuraavan merkin kirjaimellisesti. Tehtiin ns. escapetus. (https://www.gnu.org/software/bash/manual/html_node/History-Interaction.html) 
